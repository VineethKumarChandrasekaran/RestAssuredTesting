package com.backend.excelutility;
...
public class ExcelUtility {
	...
	public Object getDataFromExcel(String sheetname, int rowIndex, int colIndex)
		...
		FileInputStream file = new FileInputStream("./src/test/resource/TestData.xlsx");
	...
	public LocalDateTime getDateFromExcel(String sheetname, int rowIndex, int colIndex)
			throws EncryptedDocumentException, IOException {
		try (FileInputStream file = new FileInputStream("./src/test/resource/TestData.xlsx");
				Workbook workbook = WorkbookFactory.create(file)) {
